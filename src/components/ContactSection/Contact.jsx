                    ...
                    <div className='bg-card p-8 rounded-lg shadow-xs'>
                        ...
                        <form onSubmit={validateForm} className='space-y-6'>
                            <div>
                                ...
                                <input type="text" id='name' name='name' className='w-full px-4 py-3 rounded-md border border-input
                                 bg-background focus:outline-hidden focus:ring-2 focus:ring-primary' placeholder='Enter your name' />
                            ...
                            <div>
                                ...
                                <input type="email" id='email' name='email' className='w-full px-4 py-3 rounded-md border
                                 border-input bg-background focus:outline-hidden focus:ring-2 focus:ring-primary' placeholder='sofiqul@.com' />
                            ...
                            <div>
                                ...
                                <textarea type="text" id='message' name='message' className='w-full px-4 py-3 rounded-md border
                                 border-input bg-background focus:outline-hidden focus:ring-2 focus:ring-primary' placeholder='Hello, I`d like to talk about... ' />
                                <p id='messageError' className='text-red-400 text-start'></p>
                            </div>

                            <button type='submit' className={("cosmic-button w-full flex items-center justify-center gap-2")}>Send Message <Send size={16}></Send></button>
                        </form>
                    </div>
                </div>
            </div>
